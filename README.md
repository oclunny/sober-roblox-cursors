...
Extracts baseline cursor textures from base.apk into Sober's asset overlay folder to build the original directory structure.

Copies your chosen .png image into the overlay across standard active mouse and shift-lock cursor paths (such as ArrowCursor.png, ArrowFarCursor.png, and MouseLockedCursor.png).
